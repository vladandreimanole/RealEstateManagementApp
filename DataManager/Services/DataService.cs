...
public class DataService : IDataService
{
    ...
    public async Task<Contract> CreateContract(Contract contract)
    {
        try
        {
            ...
            contract.ContractHtml = "<!DOCTYPE  html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n<html xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"ro\" lang=\"ro\">\n   <head>\n      <meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"/>\n      <title>file_1655842102727</title>\n      <meta name=\"author\" content=\"Corina Varlan\"/>\n      <style type=\"text/css\"> * {margin:0; padding:0; text-indent:0; }\n         h1 { color: black; font-family:Arial, sans-serif; font-style: normal; font-weight: bold; text-decoration: none; font-size: 11pt; }\n         .s1 { color: black; font-family:Arial, sans-serif; font-style: italic; font-weight: normal; text-decoration: none; font-size: 11pt; }\n         .p, p { color: black; font-family:Arial, sans-serif; font-style: normal; font-weight: normal; text-decoration: none; font-size: 11pt; margin:0pt; }\n         .s2 { color: black; font-family:\"Times New Roman\", serif; font-style: normal; font-weight: normal; text-decoration: underline; font-size: 11pt; }\n         .s3 { color: black; font-family:Arial, sans-serif; font-style: normal; font-weight: normal; text-decoration: underline; font-size: 11pt; }\n         .s4 { color: black; font-style: normal; font-weight: normal; text-decoration: none; }\n         li {display: block; }\n         #l1 {padding-left: 0pt;counter-reset: c1 1; }\n         #l1> li>*:first-child:before {counter-increment: c1; content: counter(c1, decimal)\". \"; color: black; font-family:Arial, sans-serif; font-style: normal; font-weight: normal; text-decoration: none; font-size: 11pt; }\n         #l1> li:first-child>*:first-child:before {counter-increment: c1 0;  }\n         li {display: block; }\n         #l2 {padding-left: 0pt;counter-reset: d1 1; }\n         #l2> li>*:first-child:before {counter-increment: d1; content: counter(d1, decimal)\". \"; color: black; font-family:Arial, sans-serif; font-style: normal; font-weight: normal; text-decoration: none; font-size: 11pt; }\n         #l2> li:first-child>*:first-child:before {counter-increment: d1 0;  }\n         #l3 {padding-left: 0pt; }\n         #l3> li>*:first-child:before {content: \"- \"; color: black; font-family:Calibri, sans-serif; font-style: normal; font-weight: normal; text-decoration: none; font-size: 11pt; }\n         #l4 {padding-left: 0pt; }\n         #l4> li>*:first-child:before {content: \"- \"; color: black; font-family:Arial, sans-serif; font-style: normal; font-weight: normal; text-decoration: none; font-size: 11pt; }\n         li {display: block; }\n         #l5 {padding-left: 0pt; }\n         #l5> li>*:first-child:before {content: \"- \"; color: black; font-family:Arial, sans-serif; font-style: normal; font-weight: normal; text-decoration: none; font-size: 11pt; }\n      </style>\n   </head>\n   <body>\n      <h1 style=\"padding-top: 4pt;padding-left: 164pt;text-indent: 0pt;text-align: center;\">CONTRACT DE ÎNCHIRIERE</h1>\n      <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n      <p class=\"s1\" style=\"padding-left: 164pt;text-indent: 0pt;text-align: center;\">-model-</p>\n      <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n      <p style=\"padding-top: 4pt;padding-left: 5pt;text-indent: 0pt;text-align: left;\">Încheiat   astăzi {{currentDate}}   <span class=\"s2\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></p>\n      <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n      <p style=\"padding-top: 4pt;padding-left: 5pt;text-indent: 0pt;text-align: left;\">Între subsemnaţii:</p>\n      <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n      <ol id=\"l1\">\n         <li data-list-text=\"1.\">\n            <p class=\"s3\" style=\"padding-left: 41pt;text-indent: -18pt;text-align: left;\"> <span class=\"p\">{{landlordName}} domiciliat(ă) în {{landlordAddress}}</span></p>\n            <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n            <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n            <p style=\"padding-left: 41pt;text-indent: 0pt;line-height: 1pt;text-align: left;\"/>\n            <p style=\"padding-top: 5pt;padding-left: 41pt;text-indent: 0pt;text-align: left;\">posesor a B.I/C.I. seria <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u>nr. <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u>eliberat de <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></p>\n            <p class=\"s3\" style=\"padding-top: 6pt;padding-left: 41pt;text-indent: 0pt;line-height: 150%;text-align: left;\"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class=\"p\">la data de </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class=\"p\">în calitate de proprietar al imobilului situat la adresa</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </p>\n         </li>\n         <li data-list-text=\"2.\">\n            <p class=\"s3\" style=\"padding-left: 41pt;text-indent: -18pt;line-height: 150%;text-align: left;\"><span class=\"s4\">\t</span> <span class=\"p\">{{tenantName}} domiciliat(ă) în {{tenantAddress}}</span> <span class=\"p\"> posesor a B.I./C.I. seria</span> <span class=\"p\">nr. </span>&nbsp;<span class=\"p\">eliberat de </span>&nbsp;</p>\n         </li>\n      </ol>\n      <p class=\"s2\" style=\"padding-left: 41pt;text-indent: 0pt;text-align: left;\"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class=\"p\">la data de </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class=\"p\">în calitate de chiriaş.</span></p>\n      <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n      <p style=\"padding-left: 5pt;text-indent: 0pt;line-height: 150%;text-align: left;\">Primul în calitate de proprietar închiriez, iar al doilea în calitate de chiriaş iau în chirie imobilul situat la adresa <u>&nbsp;</u> compus din <u>&nbsp;&nbsp;&nbsp;&nbsp; </u>camere plus dependinţe, nemobilate / mobilate conform listei de inventar ce se va întocmi de către părţi la data intrării în imobil.</p>\n      <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n      <ol id=\"l2\">\n         <li data-list-text=\"1.\">\n            <p style=\"padding-left: 5pt;text-indent: 0pt;line-height: 150%;text-align: justify;\">Termenul de închiriere este de la data de <span class=\"s2\">&nbsp;</span>până la data de <u>&nbsp;</u> cu posibilitate de prelungire prin acordul ambelor părţi.</p>\n            <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n         </li>\n         <li data-list-text=\"2.\">\n            <p style=\"padding-left: 5pt;text-indent: 0pt;line-height: 150%;text-align: left;\">Chiria lunară este de <span class=\"s2\">&nbsp;</span>Plata se face în numerar/prin virament bancar, până la data de <u>&nbsp;</u>a lunii pentru luna în curs.</p>\n            <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n         </li>\n         <li data-list-text=\"3.\">\n            <p style=\"padding-left: 5pt;text-indent: 0pt;line-height: 150%;text-align: justify;\">Părţile au convenit astfel: chiriaşul să plătească proprietarului suma de <span class=\"s2\">&nbsp;</span>cu titlul de garanţie pentru plata chiriei și a cheltuielilor ce cad în sarcina chiriaşului şi care privesc imobilul ce face obiectul prezentului contract. Proprietarul se obligă ca la încetarea raporturilor dintre părţi, raporturi ce rezultă sau sunt consecinţa prezentului contract de închiriere, să</p>\n            <p style=\"padding-top: 4pt;padding-left: 5pt;text-indent: 0pt;text-align: left;\">restituie chiriaşului această sumă de bani.</p>\n            <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n         </li>\n         <li data-list-text=\"4.\">\n            <p style=\"padding-left: 5pt;text-indent: 0pt;line-height: 150%;text-align: left;\">În momentul încheierii contractului s-a plătit de către chiriaş suma de <u>&nbsp; </u> reprezentând <u>&nbsp;</u></p>\n            <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n         </li>\n         <li data-list-text=\"5.\">\n            <p style=\"padding-top: 4pt;padding-left: 17pt;text-indent: -12pt;text-align: left;\">Încetarea contractului se face :</p>\n            <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n            <ul id=\"l3\">\n               <li data-list-text=\"-\">\n                  <p style=\"padding-left: 41pt;text-indent: -18pt;text-align: left;\">la împlinirea termenului prevăzut la art. 1,</p>\n               </li>\n               <li data-list-text=\"-\">\n                  <p style=\"padding-top: 5pt;padding-left: 41pt;text-indent: -18pt;text-align: left;\">prin acordul ambelor părţi înainte de termen,</p>\n               </li>\n               <li data-list-text=\"-\">\n                  <p style=\"padding-top: 5pt;padding-left: 41pt;text-indent: -18pt;text-align: left;\">prin denunțare unilaterală cu un preaviz de 30 zile calendaristice,</p>\n               </li>\n               <li data-list-text=\"-\">\n                  <p style=\"padding-top: 5pt;padding-left: 41pt;text-indent: -18pt;line-height: 143%;text-align: left;\">prin reziliere în caz de nerespectare a clauzelor contractuale, fără alte formalități și fără trecerea vreunui termen.</p>\n                  <p style=\"padding-top: 8pt;padding-left: 23pt;text-indent: 0pt;line-height: 151%;text-align: left;\">În situaţia în care oricare din părţi nu respectă aceste condiţii va plăti celeilalte părţi despăgubiri în valoare de <span class=\"s2\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></p>\n                  <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n               </li>\n            </ul>\n         </li>\n         <li data-list-text=\"6.\">\n            <h1 style=\"padding-top: 4pt;padding-left: 35pt;text-indent: -12pt;text-align: left;\">OBLIGAŢIILE CHIRIAŞULUI:</h1>\n            <ul id=\"l4\">\n               <li data-list-text=\"-\">\n                  <p style=\"padding-top: 6pt;padding-left: 23pt;text-indent: 0pt;line-height: 150%;text-align: left;\">chiriaşul se obligă să folosească bunul închiriat conform destinaţiei sale, să nu tulbure liniştea proprietăţilor vecine prin folosinţa sa,</p>\n               </li>\n               <li data-list-text=\"-\">\n                  <p style=\"padding-left: 29pt;text-indent: -6pt;text-align: left;\">va preda imobilul la finalul perioadei de locaţiune în condiţiile iniţiale preluării lui,</p>\n               </li>\n               <li data-list-text=\"-\">\n                  <p style=\"padding-top: 6pt;padding-left: 29pt;text-indent: -6pt;text-align: left;\">nu va subînchiria imobilul,</p>\n               </li>\n               <li data-list-text=\"-\">\n                  <p style=\"padding-top: 6pt;padding-left: 23pt;text-indent: 0pt;line-height: 150%;text-align: left;\">să plătească la termen/scadență cheltuielile de folosinţa a imobilului (apă, gaz, electricitate, etc),</p>\n               </li>\n               <li data-list-text=\"-\">\n                  <p style=\"padding-left: 23pt;text-indent: 0pt;line-height: 150%;text-align: left;\">să respecte normele de prevenire a incendiilor şi să întreţină bunurile în folosinţă exclusive (instalaţii de apă, gaz metan, mobilier),</p>\n               </li>\n               <li data-list-text=\"-\">\n                  <p style=\"padding-left: 29pt;text-indent: -6pt;line-height: 13pt;text-align: left;\">să păstreze curăţenia şi să respecte normele de igienă în interiorul imobilului,</p>\n               </li>\n               <li data-list-text=\"-\">\n                  <p style=\"padding-top: 6pt;padding-left: 23pt;text-indent: 0pt;line-height: 150%;text-align: left;\">să restituie imobilul la data expirării contractului sau la încetarea acestuia înainte de termen în condiţiile prezentului contract,</p>\n               </li>\n               <li data-list-text=\"-\">\n                  <p style=\"padding-left: 23pt;text-indent: 0pt;line-height: 151%;text-align: left;\">să despăgubească proprietarul de eventualele daune produse imobilului sau bunurilor din interiorul acestuia din folosinţa sa,</p>\n               </li>\n               <li data-list-text=\"-\">\n                  <p style=\"padding-left: 29pt;text-indent: -6pt;line-height: 13pt;text-align: left;\">să nu schimbe destinaţia imobilului.</p>\n               </li>\n            </ul>\n            <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n         </li>\n         <li data-list-text=\"7.\">\n            <h1 style=\"padding-left: 35pt;text-indent: -12pt;text-align: left;\">OBLIGAŢIILE PROPRIETARULUI:</h1>\n         </li>\n      </ol>\n      <ul id=\"l5\">\n         <li data-list-text=\"-\">\n            <p style=\"padding-top: 4pt;padding-left: 29pt;text-indent: -6pt;text-align: left;\">proprietarul se obligă să predea imobilul la data stabilită în contract în stare de folosinţă,</p>\n         </li>\n         <li data-list-text=\"-\">\n            <p style=\"padding-top: 6pt;padding-left: 23pt;text-indent: 0pt;line-height: 150%;text-align: left;\">proprietarul se obligă să asigure locatorului imobilul potrivit destinaţiei pentru care a fost închiriat,</p>\n         </li>\n         <li data-list-text=\"-\">\n            <p style=\"padding-left: 29pt;text-indent: -6pt;line-height: 13pt;text-align: left;\">garantează chiriaşului împotriva viciilor ascunse ale imobilului <u>&nbsp;</u>,</p>\n         </li>\n         <li data-list-text=\"-\">\n            <p style=\"padding-top: 6pt;padding-left: 29pt;text-indent: -6pt;text-align: left;\">garantează pentru evicțiune.</p>\n         </li>\n      </ul>\n      <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n      <p style=\"padding-left: 5pt;text-indent: 0pt;text-align: left;\">Predarea imobilului către chiriaş se va face cel mai târziu la data de <span class=\"s2\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>.</p>\n      <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n      <p style=\"padding-left: 5pt;text-indent: 0pt;line-height: 151%;text-align: left;\">Prezentul contract conţine trei pagini şi s-a încheiat în două exemplare, astăzi fiecare parte intrând în posesia unui exemplar din contract.</p>\n      <p style=\"padding-top: 7pt;padding-left: 5pt;text-indent: 0pt;line-height: 150%;text-align: left;\">La  preluarea  imobilului,  aparatele  de  măsură  aveau  următoarele  indexuri:  Index  contor  apă  caldă  <span class=\"s2\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></p>\n      <p style=\"padding-left: 5pt;text-indent: 0pt;line-height: 13pt;text-align: left;\">Index   contor   apă  rece     <span class=\"s2\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></p>\n      <p style=\"padding-top: 6pt;padding-left: 5pt;text-indent: 0pt;text-align: left;\">Index   energie   electrică      <span class=\"s2\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></p>\n      <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n      <p style=\"padding-top: 10pt;padding-left: 5pt;text-indent: 0pt;text-align: left;\">La  data  închirierii  la  asociaţia  de  proprietari  era  de  plată  suma  de  <span class=\"s2\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></p>\n      <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n      <p style=\"text-indent: 0pt;text-align: left;\"><br/></p>\n      <h1 style=\"padding-left: 5pt;text-indent: 0pt;text-align: left;\">PROPRIETAR                                     CHIRIAŞ</h1>\n   </body>\n</html>";
    ...
    {
        var billsToDelete = _context.Bills.Where(i => i.ContractId == contractId);
    ...
    {
        return await _context.Contracts.Include(i => i.Tenant).Include(i => i.Bills).Include(i => i.Property).Where(i => i.Signed == true).ToListAsync();
    }
    ...
    public async Task<Bill> TransferPdfToDatabase(Bill pdf)
    {
        _context.Bills.Add(pdf);
        await _context.SaveChangesAsync();
        return pdf;
    }
    ...
    public async Task<Contract> GetContractById(int contractId)
    {
        ...
        //var contract = await _context.Contracts.Where(i => i.ContractId == contractId).FirstOrDefaultAsync();
        var items = _context.Contracts.Include(i => i.Property).ThenInclude(i => i.User);
        var fullContractData = items.Include(i => i.Tenant).Where(i => i.ContractId == contractId).FirstOrDefault();
        fullContractData.ContractHtml = fullContractData.ContractHtml.Replace("{{tenantName}}", fullContractData.Tenant.FirstName + " " + fullContractData.Tenant.LastName);
        fullContractData.ContractHtml = fullContractData.ContractHtml.Replace("{{tenantAddress}}", fullContractData.Tenant.Address);
        fullContractData.ContractHtml = fullContractData.ContractHtml.Replace("{{landlordName}}", fullContractData.Property.User.FirstName + " " + fullContractData.Property.User.LastName);
        fullContractData.ContractHtml = fullContractData.ContractHtml.Replace("{{landlordAddress}}", fullContractData.Property.User.Address);
        fullContractData.ContractHtml = fullContractData.ContractHtml.Replace("{{currentDate}}", DateTime.Now.ToString("dd.MM.yyyy"));
        fullContractData.ContractHtml = fullContractData.ContractHtml.Replace("suma de ", "suma de " + "$" + fullContractData.Property.Value);
        var contract = new Contract
        {
            ContractId = fullContractData.ContractId,
            PropertyId = fullContractData.PropertyId,
            TenantId = fullContractData.TenantId,
            Signed = fullContractData.Signed,
            Property = new Property
            {
                Address = fullContractData.Property.Address,
                User = new User
                {
                    FirstName = fullContractData.Property.User.FirstName,
                    LastName = fullContractData.Property.User.LastName,
                    PhoneNumber = fullContractData.Property.User.PhoneNumber
                }
            },
            Tenant = new User
            {
                FirstName = fullContractData.Tenant.FirstName,
                LastName = fullContractData.Tenant.LastName,
                PhoneNumber = fullContractData.Tenant.PhoneNumber,
            },
            ContractHtml = fullContractData.ContractHtml,
        };
        return contract;
    }
